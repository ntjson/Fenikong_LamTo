...
class ReportsApi {
  ...
  Future<Response<ReportSummary>> reportsCreate({
    ...
    ReportSummary? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ReportSummary),
      ) as ReportSummary;
  ...
  Future<Response<InfoReplyResult>> reportsInfoReplyCreate({
    ...
    final _path = r'/api/v1/reports/{id}/info-reply'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InfoReplyRequest);
      _bodyData = _serializers.serialize(infoReplyRequest, specifiedType: _type);
    ...
    InfoReplyResult? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(InfoReplyResult),
      ) as InfoReplyResult;
    ...
    return Response<InfoReplyResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PaginatedReportSummaryList>> reportsList({
    ...
    PaginatedReportSummaryList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedReportSummaryList),
      ) as PaginatedReportSummaryList;
    ...
    return Response<PaginatedReportSummaryList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ReportPhoto>> reportsPhotosCreate({
    ...
    final _path = r'/api/v1/reports/{id}/photos'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ReportPhoto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ReportPhoto),
      ) as ReportPhoto;
  ...
  Future<Response<ReportDetail>> reportsRetrieve({
    ...
    final _path = r'/api/v1/reports/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
