...
class NotificationsApi {
  ...
  Future<Response<PaginatedNotificationFeedList>> notificationsList({
    ...
    PaginatedNotificationFeedList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedNotificationFeedList),
      ) as PaginatedNotificationFeedList;
    ...
    return Response<PaginatedNotificationFeedList>(
      data: _responseData,
  ...
  Future<Response<void>> notificationsReadCreate({
    ...
    final _path = r'/api/v1/notifications/{id}/read'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
